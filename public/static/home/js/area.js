function locationCard(settings) {
    ...
    function createX(countys) {
        ...
        //如果没有创建过
        html += '<div id="__' + countyInputId + '" class="countys clearfix" style="display:none; z-index:9999;">';
        for (var i = 0; i < countys.length; i++) {
            html += '<a class="a" href="javascript:;">' + countys[i] + '</a>';
        }
        html += '</div>';
    ...
    function createC(citys) {
        ...
        //如果没有创建过
        html += '<div id="__' + cityInputId + '" class="citys clearfix" style="display:none; z-index:9999;">';
        for (var i = 0; i < citys.length; i++) {
            html += '<a class="a" href="javascript:;">' + citys[i] + '</a>';
        }
        html += '</div>';
    ...
    function createP() {
        ...
        //如果没有创建过
        var html = '<div id="__' + provinceInputId + '" class="privinces clearfix" style="display:none; z-index:9999;">';
