<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/other/edit_other.html";i:1532138656;s:79:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/public/header.html";i:1532138656;s:79:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/public/footer.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal m-t" name="edit" id="edit" method="post" action="edit_other">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="title" type="text" class="form-control" name="title" value="<?php echo $other['title']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="sortnum" type="text" class="form-control input_wd1" name="sortnum" placeholder="输入序号" value="<?php echo $other['sortnum']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <div class="uploadImg-box">
                                    ...
                                    <div class="up-img <?php if($other['photo'] != ''): ?>hidden-box<?php endif; ?>"><i class="fa fa-cloud-upload"></i><p>点击上传图片</p></div>
                                    <?php if($other['photo'] != ''): ?>
                                    <input type="checkbox" name="delPhoto" class="input-del" value="1" />
                                    <div class="imgView"><img src="__UPLOAD_PATH__/<?php echo $other['photo']; ?>"/></div>
                                    <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="url" type="text" class="form-control" name="url" placeholder="请输入连接地址" value="<?php echo $other['url']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-2">
                                <select class="form-control" name="cateId">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>" <?php if($other['cateId'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['lefthtml']; ?><?php echo $vo['name']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 input-group">
                                <input type="checkbox" name="status" value="1" class="lcs_check" lcs-text="开启|关闭" autocomplete="off" <?php if($other['status'] == 1): ?>checked<?php endif; ?>/>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
