<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"E:\php_project\single.jzb.com\public/../application/admin/view/role/index.html";i:1532138656;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/header.html";i:1532138656;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/footer.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div  class="col-sm-2 ibox-tit" style="width: 100px">
                    <div class="input-group" >  
                        <a href="<?php echo url('roleAdd'); ?>"><button class="btn btn-primary" type="button">添加角色</button></a>
                    </div>
                </div>                                            
                        ...
                        <script id="list-template" type="text/html">
                            {{# for(var i=0;i<d.length;i++){  }}
                                <tr class="long-td">
                                    ...
                                    {{# if(d[i].id!==1){ }}
                                    <td>
                                        <input type="checkbox" name="status" data-id="{{d[i].id}}" data-table="auth_group" class="lcs_check lcs_switch lcs_sm" {{d[i].status==1?'checked':''}}/>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:;" onclick="roleEdit({{d[i].id}})" class="btn btn-blue btn-outline btn-xs">
...
<script type="text/javascript">
    ...
    function roleDel(id){
        layer.confirm('确认删除此信息?', {icon: 3, title:'提示'}, function(index){
            $.getJSON('<?php echo url("roleDel"); ?>', {'id':id}, function(res){
                if(res.code == 1){
