<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/applet/edit_nav.html";i:1532138656;s:79:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/public/header.html";i:1532138656;s:79:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/public/footer.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="edit_nav" id="edit_nav" method="post" action="<?php echo url('edit_nav'); ?>">
                        <input type="hidden" name="id" value="<?php echo $nav['id']; ?>">
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">导航名称：</label>
                            <div class="input-group col-sm-4">
                                <input id="name" type="text" class="form-control" name="name" value="<?php echo $nav['name']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="sortnum" type="text" class="form-control input_wd1" name="sortnum" value="<?php echo $nav['sortnum']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <select name="cateId" class="form-control" id="cateId">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>" <?php if($nav['cateId'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <div class="uploadImg-box">
                                    ...
                                    <div class="up-img <?php if($nav['photo'] != ''): ?>hidden-box<?php endif; ?>"><i class="fa fa-cloud-upload"></i><p>点击上传图片</p></div>
                                    <?php if($nav['photo'] != ''): ?>
                                    <input type="checkbox" name="delPhoto" class="input-del" value="1" />
                                    <div class="imgView"><img src="__UPLOAD_PATH__/<?php echo $nav['photo']; ?>"/></div>
                                    <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 input-group">
                                <input type="checkbox" name="status" value="1" class="lcs_check" lcs-text="开启|关闭" autocomplete="off" <?php if($nav['status'] == 1): ?>checked<?php endif; ?>/>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
