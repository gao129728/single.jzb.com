<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"E:\php_project\single.jzb.com\public/../application/admin/view/article/edit_article.html";i:1533006208;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/header.html";i:1532138656;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/footer.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane active">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 input-group">
                                        <input type="checkbox" name="isTop" value="1" class="lcs_check" lcs-text="是|否" autocomplete="off" <?php if($article['isTop'] == 1): ?>checked<?php endif; ?>/>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 input-group">
                                        <input type="checkbox" name="status" value="1" class="lcs_check" lcs-text="开启|关闭" autocomplete="off" <?php if($article['status'] == 1): ?>checked<?php endif; ?>/>
                                    </div>
                                </div>
                            </div>
                            <div id="tab-2" class="tab-pane">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        <input id="website" type="text" class="form-control" name="website" value="<?php echo $article['website']; ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                            ...
                            <div id="tab-3" class="tab-pane">
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-7">
                                        <textarea name="intro" id="myEditor1" style="width:100%"><?php echo $article['intro']; ?></textarea>
                                        <script type="text/javascript">
