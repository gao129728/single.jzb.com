<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"E:\php_project\single.jzb.com\public/../application/admin/view/article/article_recycle.html";i:1532327248;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/header.html";i:1532138656;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/footer.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <script id="list-template" type="text/html">
                            {{# for(var i=0;i<d.length;i++){  }}
                                <tr class="long-td lightBoxGallery">
                                    ...
                                    <td>{{d[i].name}}</td>                                 
                                    <td>
                                    	<a href="__UPLOAD_PATH__/{{d[i].photo}}" title="" data-gallery=""><img src="__UPLOAD_PATH__/{{d[i].photo}}" style="height: 30px" onerror="this.src='/static/admin/images/no_img.jpg'"/></a>
                                    </td> 
                                    <td>{{d[i].views}}</td>
