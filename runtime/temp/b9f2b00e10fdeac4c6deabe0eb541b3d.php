<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\php\testjzb.ahcfwl.com\public/../application/admin/view/ad/add_ad.html";i:1532138656;s:77:"E:\php\testjzb.ahcfwl.com\public/../application/admin/view/public/header.html";i:1532138656;s:77:"E:\php\testjzb.ahcfwl.com\public/../application/admin/view/public/footer.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" name="add" id="add" method="post" action="add_ad">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="orderby" type="text" value="<?php echo $orderby; ?>" class="form-control input_wd1" name="orderby" >
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-10">
                                ...
                                <div class="col-sm-1 input_wd3">
                                    <input type="text" class="form-control" name="width" id="width" value="150">
                                    <span class="tp-unit">px</span>
                                </div>
                                <span class="control-label" style="float:left; padding-left:60px;">高度</span>
                                <div class="col-sm-1 input_wd3">
                                    <input type="text" class="form-control" name="height" id="height" value="150">
                                    <span class="tp-unit">px</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4" style="width:446px;">
                                <input type="text" class="form-control input_wd2 select-date" name="start_date" id="start_date" readonly="readonly" style="background:url(__IMG__/WdatePicker.jpg) no-repeat 97% center">
                                <span style="float:left; line-height:30px; padding:0 10px; color:#999;">—</span>
                                <input type="text" class="form-control input_wd2 select-date" name="end_date" id="end_date" readonly="readonly" style="background:url(__IMG__/WdatePicker.jpg) no-repeat 97% center">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 input-group">
                                <div class="radio i-checks">
                                    <input type="radio" name='ad_position' value="0" checked/>首页显示&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" name='ad_position' value="1" />全部页面显示
                                </div>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 input-group">
                                <input type="checkbox" name="closed" value="1" class="lcs_check" lcs-text="是|否" autocomplete="off" checked/>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 input-group">
                                <div class="radio i-checks">
                                    <input type="radio" name='mode' value="popup" checked/>弹窗广告&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" name='mode' value="float" />全屏漂浮广告&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" name='mode' value="hangL" />左侧浮动广告&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" name='mode' value="hangR" />右侧浮动广告&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" name='mode' value="pullScreen" />拉屏广告
                                </div>
                            </div>
                        </div>
                        <div class="top-left-aside hidden-box">
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">顶部距离：</label>
                                <div class="col-sm-1 input_wd3" style="padding-left:0;">
                                    <input id="asidetop" type="text" value="200" class="form-control" name="asidetop" >
                                    <span class="tp-unit">px</span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-1 input_wd3" style="padding-left:0;">
                                    <input id="asideleft" type="text" value="5" class="form-control" name="asideleft" >
                                    <span class="tp-unit">px</span>
                                </div>
                            </div>
                        </div>
                        <div class="pull-screen-time hidden-box">
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">拉屏时间：</label>
                                <div class="col-sm-1 input_wd3" style="padding-left:0;">
                                    <input id="screen_time" type="text" value="4" class="form-control" name="screen_time">
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <div class="col-sm-2 col-sm-offset-2 button-group">
