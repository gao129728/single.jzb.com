...
<div class="MainCon inside-container">
	<div class="box-wrap">
		<div class="breadcrumbs">
			您现在的位置：<a href="<?php echo url('home/index/index'); ?>">首页</a> > <?php echo $base_name; ?> > <?php echo $keyword; ?>
		</div>
		<div class="inside-box clearfix">
			<div class="centerCon">
				<?php if($count > 0): ?>
				<h4 class="search_cnt_txt">共查询到<span><?php echo $count; ?></span>条相关信息</h4>
				<div class="search_list">
					<?php if(is_array($search_list) || $search_list instanceof \think\Collection || $search_list instanceof \think\Paginator): $i = 0; $__LIST__ = $search_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
					<div class="list-item clearfix">
						...
						<?php endif; ?>
						<div class="txt">
							<h4><a href="<?php echo $item['url']; ?>" title="<?php echo $item['title']; ?>" <?php if($item['website'] != ''): ?>target="_blank"<?php endif; ?>><?php echo $item['k_title']; ?></a></h4>
				...
				<div class="page"><?php echo $search_list->render(); ?></div>
				<?php else: ?>
