<?php if (!defined('THINK_PATH')) exit(); /*a:12:{s:84:"C:\Users\EDZ\Desktop\single.jzb.com\public/../application/home/view/index/index.html";i:1650357167;s:84:"C:\Users\EDZ\Desktop\single.jzb.com\public/../application/home/view/public/head.html";i:1532138656;s:86:"C:\Users\EDZ\Desktop\single.jzb.com\public/../application/home/view/public/header.html";i:1543281040;s:94:"C:\Users\EDZ\Desktop\single.jzb.com\public/../application/home/view/index-module/module_1.html";i:1532138656;s:94:"C:\Users\EDZ\Desktop\single.jzb.com\public/../application/home/view/index-module/module_2.html";i:1545012560;s:94:"C:\Users\EDZ\Desktop\single.jzb.com\public/../application/home/view/index-module/module_3.html";i:1532138656;s:94:"C:\Users\EDZ\Desktop\single.jzb.com\public/../application/home/view/index-module/module_4.html";i:1532138656;s:94:"C:\Users\EDZ\Desktop\single.jzb.com\public/../application/home/view/index-module/module_5.html";i:1532138656;s:94:"C:\Users\EDZ\Desktop\single.jzb.com\public/../application/home/view/index-module/module_6.html";i:1532138656;s:94:"C:\Users\EDZ\Desktop\single.jzb.com\public/../application/home/view/index-module/module_7.html";i:1532138656;s:86:"C:\Users\EDZ\Desktop\single.jzb.com\public/../application/home/view/public/footer.html";i:1532138656;s:88:"C:\Users\EDZ\Desktop\single.jzb.com\public/../application/home/view/public/onlineqq.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="header-box">
	<?php if($config['web_nav_style'] < 4 or $config['web_nav_style'] == 7): ?>
	...
	<div class="header">
	    <h1 class="logo">
	        <a href="<?php echo url('home/index/index'); ?>" title="<?php echo $config['web_site_name']; ?>"><img src="__UPLOAD_PATH__/<?php echo $config['web_site_logo']; ?>" alt="<?php echo $config['web_site_name']; ?>"/></a>
	    </h1>
	</div>
	<!--导航-->
	<div class="MainNav">
    ...
    <?php elseif($config['web_nav_style'] == 5 or ($config['web_nav_style'] == 6 and $navCur != 'index')): ?>
    <div class="MainNav-5">
      <div class="clearfix">
          <h1 class="lef">
              <a href="<?php echo url('home/index/index'); ?>" title="<?php echo $config['web_site_name']; ?>"><img src="__UPLOAD_PATH__/<?php echo $config['web_site_logo']; ?>" alt="<?php echo $config['web_site_name']; ?>"/></a>
  ...
  <?php elseif($config['web_nav_style'] == 6 and $navCur == 'index'): ?>
  <div class="MainNav-6" style="height:<?php echo $banner_config['height']; ?>px;">
      <h1 class="lef">
        <a href="<?php echo url('home/index/index'); ?>" title="<?php echo $config['web_site_name']; ?>"><img src="__UPLOAD_PATH__/<?php echo $config['web_site_logo']; ?>" alt="<?php echo $config['web_site_name']; ?>"/></a>
      </h1>
      <div class="nav-6">
        <ul class="clearfix">
          <li <?php if($navCur == 'index'): ?>class="on"<?php endif; ?>><a href="<?php echo url('home/index/index'); ?>">网站首页</a></li>
          <?php if(is_array($nav_cate) || $nav_cate instanceof \think\Collection || $nav_cate instanceof \think\Paginator): $i = 0; $__LIST__ = $nav_cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
          <li <?php if($navCur == $nav['id']): ?>class="on"<?php endif; ?>><a href="<?php echo $nav['url']; ?>" title="<?php echo $nav['name']; ?>" <?php if($nav['isTarget'] == 1): ?>target="_blank"<?php endif; ?>><?php echo $nav['name']; ?></a></li>
          <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
      </div>
      <?php if($config['web_site_member'] == 1): ?>
  ...
  <?php elseif($config['web_nav_style'] == 7): ?>
  <div class="MainNav-7">
	    <div class="box-wrap clearfix">
	        <h1 class="lef fl">
	            <a href="<?php echo url('home/index/index'); ?>" title="<?php echo $config['web_site_name']; ?>"><img src="__UPLOAD_PATH__/<?php echo $config['web_site_logo']; ?>" alt="<?php echo $config['web_site_name']; ?>"/></a>
	        ...
	        <div class="nav">
	            <ul class="clearfix">
	                <li <?php if($navCur == 'index'): ?>class="on"<?php endif; ?>><a href="<?php echo url('home/index/index'); ?>">网站首页</a></li>
	                <?php if(is_array($nav_cate) || $nav_cate instanceof \think\Collection || $nav_cate instanceof \think\Paginator): $i = 0; $__LIST__ = $nav_cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
	                <li class="li <?php if($navCur == $nav['id']): ?>on<?php endif; ?>"><a href="<?php echo $nav['url']; ?>" title="<?php echo $nav['name']; ?>" <?php if($nav['isTarget'] == 1): ?>target="_blank"<?php endif; ?>><?php echo $nav['name']; ?></a>
	                </li>
	                <?php endforeach; endif; else: echo "" ;endif; ?>
	            </ul>
	        </div>
	    ...
	    <div class="subNav">
	    	<div class="box-wrap">
	    		<ul class="clearfix">
	                <?php if(is_array($nav_cate) || $nav_cate instanceof \think\Collection || $nav_cate instanceof \think\Paginator): $i = 0; $__LIST__ = $nav_cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
	                <li>
	                	<h4><a href="<?php echo $nav['url']; ?>" title="<?php echo $nav['name']; ?>" <?php if($nav['isTarget'] == 1): ?>target="_blank"<?php endif; ?>><?php echo $nav['name']; ?></a></h4>
                  		<?php if($nav['sub']): ?>
	                	<dl>
	                		<?php if(is_array($nav['sub']) || $nav['sub'] instanceof \think\Collection || $nav['sub'] instanceof \think\Paginator): $i = 0; $__LIST__ = $nav['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	                        <dt><a href="<?php echo $vo['url']; ?>" title="<?php echo $vo['name']; ?>" <?php if($vo['isTarget'] == 1): ?>target="_blank"<?php endif; ?>><?php echo $vo['name']; ?></a></dt>
	    ...
	    <script type="text/javascript">
	    var li_cnt = $('.MainNav-7 .subNav li').size();
	    if(li_cnt > 0){
	    	$('.MainNav-7 .subNav li').width(1200/li_cnt);
	    }
	    Nav_1();
	    </script>
	    <?php endif; ?>
...
<script type="text/javascript">
	...
	var mheight=$(".MainNav-6 .nav-6").height();
	$(".MainNav-6 .nav-6").css("margin-top",-mheight/2);
</script>
<!--banner-->
...
<!--主要内容-->
<div class="MainCon">
    <?php if($config['web_site_search'] == 1): ?>
