<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"E:\php_project\single.jzb.com\public/../application/admin/view/website/config.html";i:1542789764;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/header.html";i:1532138656;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/footer.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab-2" class="tab-pane">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 input-group">
                                            <div class="radio i-checks clearfix">
                                                ...
                                                <span class="group_item"><input type="radio" name='config[web_nav_style]' value="5" <?php if($config['web_nav_style'] == 5): ?>checked<?php endif; ?>/>导航样式5</span>
                                                <span class="group_item"><input type="radio" name='config[web_nav_style]' value="6" <?php if($config['web_nav_style'] == 6): ?>checked<?php endif; ?>/>导航样式6</span>
                                                <span class="group_item"><input type="radio" name='config[web_nav_style]' value="7" <?php if($config['web_nav_style'] == 7): ?>checked<?php endif; ?>/>导航样式7</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 input-group">
                                            <input type="checkbox" name="config[web_site_search]" value="1" class="lcs_check" lcs-text="开启|关闭" autocomplete="off" <?php if($config['web_site_search'] == 1): ?>checked<?php endif; ?>/>
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
