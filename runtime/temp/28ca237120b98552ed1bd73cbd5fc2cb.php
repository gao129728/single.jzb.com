<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:90:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/appletmodule/edit_module.html";i:1532138656;s:79:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/public/header.html";i:1532138656;s:85:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/appletmodule/global.html";i:1532138656;s:79:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/public/footer.html";i:1532138656;s:88:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/appletmodule/global_js.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<style type="text/css">
    ...
    .multi-img .upload-list .img{width:auto; max-height:78px;}
</style>
            ...
            <ul id="sortable" class="Ulsort">
                ...
                <li class="ui-state <?php if($module_id == $item['id']): ?>active<?php endif; ?>">
                    ...
                    <span class="handle-btn">
                        ...
                        <a href="<?php echo url('appletmodule/edit_module',['id'=>$item['id']]); ?>"><i class="fa fa-pencil" data-toggle="tooltip" title="编辑"></i></a>
                        ...
                        <form class="form-horizontal" name="edit_module" id="edit_module" method="post" action="<?php echo url('edit_module'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-4">
                                    <div class="iColor-Picker">
                                        <input id="bgcolor" type="text" class="form-control iColorPicker input_wd1" name="bgcolor" maxlength="7" value="<?php echo $module['bgcolor']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4 input-group">
                                    <div class="uploadImg-box">
                                        ...
                                        <div class="up-img <?php if($module['bgphoto'] != ''): ?>hidden-box<?php endif; ?>"><i class="fa fa-cloud-upload"></i><p>点击上传图片</p></div>
                                        <?php if($module['bgphoto'] != ''): ?>
                                        <input type="checkbox" name="delbgphoto" class="input-del" value="1" />
                                        <div class="imgView"><img src="__UPLOAD_PATH__/<?php echo $module['bgphoto']; ?>"/></div>
                                        <?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-10">
                                    ...
                                    <div class="col-sm-1 input_wd3">
                                        <input type="text" class="form-control" id="topSpace" name="topSpace" value="<?php echo $module['topSpace']; ?>">
                                        <span class="tp-unit">px</span>
                                    </div>
                                    <span class="control-label" style="float:left; padding-left:60px;">下边距</span>
                                    <div class="col-sm-1 input_wd3">
                                        <input type="text" class="form-control" id="bottomSpace" name="bottomSpace" value="<?php echo $module['bottomSpace']; ?>">
                                        <span class="tp-unit">px</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-8">
                                    <div class="radio i-checks">
                                        ...
                                        <input type="radio" name='titleStyle' value="2" <?php if($module['titleStyle'] == 2): ?>checked<?php endif; ?>/>自定义&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name='titleStyle' value="0" <?php if($module['titleStyle'] == 0): ?>checked<?php endif; ?>/>无标题
                                    </div>
                                </div>
                            </div>
                            <div class="tit-pic <?php if($module['titleStyle'] != 2): ?>hidden-box<?php endif; ?>">
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                ...
                                <div class="col-sm-9 input-group">
                                    <div class="panel-options">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class="nav-tab-<?php echo $key; if($module['module_style'] == $key): ?> active<?php endif; ?>">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div id="tab-2" class="tab-pane <?php if($module['module_style'] == 2): ?>active<?php endif; ?>">
                                            <div class="param-set-box">
                                                <div class="set-item">
                                                    <input type="hidden" name="paramCnt[2]" value="6">
                                                    <div class="item clearfix">
                                                        <label class="item-label">显示个数</label>
                                        ...
                                        <div id="tab-4" class="tab-pane <?php if($module['module_style'] == 4): ?>active<?php endif; ?>">
                                            ...
                                            <div class="col-sm-12" style="padding:0 0 8px; margin-top:-5px;">
                                                <ul class="multi-img" id="multi-img-sortable">
                                                    <?php if(is_array($module['module_content']) || $module['module_content'] instanceof \think\Collection || $module['module_content'] instanceof \think\Paginator): $i = 0; $__LIST__ = $module['module_content'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                    <li>
                                                        <input type="hidden" name="img_id[]" value="<?php echo $module_id; ?>" class="img_id">
                                                        <input type="hidden" name="img_src[]" value="<?php echo $vo; ?>" class="img_src">
                                                        <div class="handle"><i class="fa fa-arrows"></i></div>
                                                        <div class="upload-list clearfix">
                                                            <div class="pull-left"><img src="__UPLOAD_PATH__/<?php echo $vo; ?>" class="img"/></div>
                                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 input-group">
                                    <input type="checkbox" name="status" value="1" class="lcs_check" lcs-text="开启|关闭" autocomplete="off" <?php if($module['status'] == 1): ?>checked<?php endif; ?>/>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
            ...
            $.getJSON('<?php echo url("del_module"); ?>', {'id':id}, function(res){
                if(res.code == 1){
                    layer.msg(res.msg,{icon:1,time:2000,shade: 0.1},function(){
                        layer.close(index);
                        window.location.href='<?php echo url("appletmodule/index"); ?>'
                    });
                }else{
...
<script type="text/javascript" src="/static/admin/webUploader/upload_adv.js"></script>
<script type="text/javascript">
    ...
    $('#multi-img-sortable').on('click','.status-move', function(){
        ...
        layer.confirm('确认删除此图片吗?', {icon: 3, title:'提示'}, function(index){
            var id = _this.siblings('.img_id').val();
            var img_src = _this.siblings('.img_src').val();
            $.getJSON("<?php echo url('appletmodule/del_module_img'); ?>", {'id':id,'img_src':img_src}, function(res){
                if(res.code == 1){
                    _this.parent().remove();
                }else{
                    layer.msg(res.msg,{icon:0,time:1500,shade: 0.1});
