<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:87:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/wapmodule/edit_module.html";i:1532138656;s:79:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/public/header.html";i:1532138656;s:82:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/wapmodule/global.html";i:1532138656;s:79:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/public/footer.html";i:1532138656;s:85:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/wapmodule/global_js.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="col-sm-8">
                        <form class="form-horizontal" name="edit_module" id="edit_module" method="post" action="<?php echo url('edit_module'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-8">
                                    <div class="radio i-checks">
                                        ...
                                        <input type="radio" name='titleStyle' value="2" <?php if($module['titleStyle'] == 2): ?>checked<?php endif; ?>/>标签切换&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name='titleStyle' value="3" <?php if($module['titleStyle'] == 3): ?>checked<?php endif; ?>/>自定义&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name='titleStyle' value="0" <?php if($module['titleStyle'] == 0): ?>checked<?php endif; ?>/>无标题
                                    </div>
                                </div>
                            </div>
                            <div class="tit-pic <?php if($module['titleStyle'] != 3): ?>hidden-box<?php endif; ?>">
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="content-source <?php if($module['titleStyle'] == 2): ?>hidden-box<?php endif; ?>">
                                ...
                                <div class="title-source <?php if($module['titleStyle'] != 2): ?>hidden-box<?php endif; ?>">
                                ...
                                <div class="col-sm-9 input-group">
                                    <div class="panel-options">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class="nav-tab-<?php echo $key; if(($key == 4 or $key == 5) and $module['titleStyle'] == 2): ?> hidden-box<?php elseif($module['module_style'] == $key): ?> active<?php endif; ?>">
