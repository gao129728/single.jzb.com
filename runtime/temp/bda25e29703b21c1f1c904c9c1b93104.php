<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"E:\php_project\single.jzb.com\public/../application/admin/view/article/edit_cate.html";i:1534929950;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/header.html";i:1532138656;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/footer.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane active">
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        <select name="parent_id" class="form-control">
                                            <option value="0" <?php if($cate['parent_id'] == 0): ?>selected<?php endif; ?>>-- 默认顶级 --</option>
                                            <?php if(is_array($cate_tree) || $cate_tree instanceof \think\Collection || $cate_tree instanceof \think\Paginator): if( count($cate_tree)==0 ) : echo "" ;else: foreach($cate_tree as $key=>$v): if($v['lvl'] < \think\Config::get('max_cate_class')): ?>
                                                <option value="<?php echo $v['id']; ?>" <?php if($cate['parent_id'] == $v['id']): ?>selected<?php endif; ?> style="margin-left:55px;"><?php echo $v['lefthtml']; ?><?php echo $v['name']; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        <input id="orderby" type="text" class="form-control input_wd1" name="orderby" value="<?php echo $cate['orderby']; ?>">
                                    </div>
                                </div>
                                <!--<div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        <input id="en_name" type="text" class="form-control" name="en_name" value="<?php echo $cate['en_name']; ?>" >
                                    </div>
                                </div>-->
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        <input id="catedir" type="text" class="form-control" name="catedir" value="<?php echo $cate['catedir']; ?>" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        <div class="uploadImg-box">
                                            ...
                                            <div class="up-img <?php if($cate['photo'] != ''): ?>hidden-box<?php endif; ?>"><i class="fa fa-cloud-upload"></i><p>点击上传图片</p></div>
                                            <?php if($cate['photo'] != ''): ?>
                                            <input type="checkbox" name="delPhoto" class="input-del" value="1" />
                                            <div class="imgView"><img src="__UPLOAD_PATH__/<?php echo $cate['photo']; ?>"/></div>
                                            <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        <input id="website" type="text" class="form-control" name="website" value="<?php echo $cate['website']; ?>" >
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 input-group">
                                            <div class="radio i-checks">
                                                <input type="radio" name='cateStyle' value="0" <?php if($cate['cateStyle'] == 0): ?>checked<?php endif; ?>/>单页模式&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="radio" name='cateStyle' value="1" <?php if($cate['cateStyle'] == 1): ?>checked<?php endif; ?>/>新闻列表&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="radio" name='cateStyle' value="2" <?php if($cate['cateStyle'] == 2): ?>checked<?php endif; ?>/>图片列表&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="radio" name='cateStyle' value="3" <?php if($cate['cateStyle'] == 3): ?>checked<?php endif; ?>/>图文列表&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="radio" name='cateStyle' value="4" <?php if($cate['cateStyle'] == 4): ?>checked<?php endif; ?>/>表单页&nbsp;&nbsp;&nbsp;&nbsp;
                                            </div>
                                            <div class="param-set-box">
                                                <div class="set-item set-item-0 <?php if($cate['cateStyle'] != 0): ?>hidden-box<?php endif; ?>">
                                                    ...
                                                    <div class="item clearfix">
                                                        ...
                                                        <div class="con">
                                                            <select class="form-control chosen-select input_wd2" name="styleParam[0][0]">
                                                                <option value="0" <?php if($cateParam[0][0] == 0): ?>selected<?php endif; ?>>内容模式</option>
                                                                <option value="1" <?php if($cateParam[0][0] == 1): ?>selected<?php endif; ?>>专题模式</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="set-item set-item-1 <?php if($cate['cateStyle'] != 1): ?>hidden-box<?php endif; ?>">
                                                ...
                                                <div class="set-item set-item-2 <?php if($cate['cateStyle'] != 2): ?>hidden-box<?php endif; ?>">
                                                ...
                                                <div class="set-item set-item-3 <?php if($cate['cateStyle'] != 3): ?>hidden-box<?php endif; ?>">
                                                ...
                                                <div class="set-item set-item-4 <?php if($cate['cateStyle'] != 4): ?>hidden-box<?php endif; ?>">
                                ...
                                <div class="info-style <?php if($cate['cateStyle'] == 0 or $cate['cateStyle'] == 4): ?>hidden-box<?php endif; ?>">
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">详情样式：</label>
                                        <div class="col-sm-10 input-group">
                                            <div class="radio i-checks">
                                                <input type="radio" name='infoStyle' value="0" <?php if($cate['infoStyle'] == 0): ?>checked<?php endif; ?>/>内容模式&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="radio" name='infoStyle' value="1" <?php if($cate['infoStyle'] == 1): ?>checked<?php endif; ?>/>产品模式
                                            </div>
                                            <div class="param-set-box">
                                                <div class="set-item set-item-1 <?php if($cate['infoStyle'] != 1): ?>hidden-box<?php endif; ?>">
                                ...
                                <div class="isForm <?php if($cate['cateStyle'] == 4): ?>hidden-box<?php endif; ?>">
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">显示留言表单：</label>
                                        <div class="col-sm-10 input-group">
                                            <div class="radio i-checks">
                                                <input type="radio" name='isForm' value="0" <?php if($cate['isForm'] == 0): ?>checked<?php endif; ?>/>否&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="radio" name='isForm' value="1" <?php if($cate['isForm'] == 1): ?>checked<?php endif; ?>/>是
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 input-group">
                                        <input type="checkbox" name="status" value="1" class="lcs_check" lcs-text="开启|关闭" autocomplete="off" <?php if($cate['status'] == 1): ?>checked<?php endif; ?>/>
                                    </div>
                                </div>
                            </div>
                            <div id="tab-2" class="tab-pane">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 input-group">
                                        <input type="checkbox" name="isTarget" value="1" class="lcs_check" lcs-text="是|否" autocomplete="off" <?php if($cate['isTarget'] == 1): ?>checked<?php endif; ?>/>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 input-group">
                                        <input type="checkbox" name="isNav" value="1" class="lcs_check" lcs-text="是|否" autocomplete="off" <?php if($cate['isNav'] == 1): ?>checked<?php endif; ?>/>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        <input id="seo_title" type="text" class="form-control" name="seo_title" value="<?php echo $cate['seo_title']; ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        <input id="keyword" type="text" class="form-control" name="keyword" value="<?php echo $cate['keyword']; ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        <textarea type="text" rows="3" name="description" id="description" class="form-control"><?php echo $cate['description']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
