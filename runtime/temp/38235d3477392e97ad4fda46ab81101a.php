<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"E:\php_project\single.jzb.com\public/../application/admin/view/banner/applet_banner.html";i:1532138656;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/header.html";i:1532138656;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/footer.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="panel blank-panel">
                        <div class="panel-options">
                            <ul class="nav nav-tabs">
                                ...
                                <li <?php if($banner['id'] == $vo['id']): ?>class="active"<?php endif; ?>><a href="<?php echo url('banner/applet_banner', ['id'=>$vo['id']]); ?>"><?php echo $vo['name']; ?></a></li>
                        ...
                        <form action="<?php echo url('save_banner'); ?>" method="post" class="form-horizontal" id="banner">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">圆点切换：</label>
                                    <div class="input-group col-sm-1">
                                    	...
                                    	<span class="help-question"><a data-toggle="tooltip" data-placement="auto right" title="banner尺寸：640*360px"><i class="fa fa-question-circle-o"></i></a></span>
                                    </div>
