<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"E:\php_project\single.jzb.com\public/../application/admin/view/menu/index.html";i:1532138656;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/header.html";i:1532138656;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/footer.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                            ...
                            <tbody>                       
                                <?php if(is_array($admin_rule) || $admin_rule instanceof \think\Collection || $admin_rule instanceof \think\Paginator): if( count($admin_rule)==0 ) : echo "" ;else: foreach($admin_rule as $key=>$v): ?>
                                    <tr class="long-td">
                                        ...
                                        <td>
                                            <input type="checkbox" name="status" data-id="<?php echo $v['id']; ?>" data-table="auth_rule" class="lcs_check lcs_switch lcs_sm" <?php if($v['status'] == 1): ?>checked<?php endif; ?>/>
                                        </td>
                                        ...
                                        <td>                                   
                                            <a href="<?php echo url('edit_rule',['id'=>$v['id']]); ?>" class="btn btn-blue btn-outline btn-xs">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" name="add_rule" id="add_rule" method="post" action="<?php echo url('add_rule'); ?>">
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 input-group">
                                ...
                                <span class="help-block m-b-none">如：admin/user/adduser (上级节点添加“#”即可)</span>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer" style="text-align: left; padding-left:25%;">
                        <button type="submit" class="btn btn-warning"><i class="fa fa-save"></i> 保存</button>
