<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"E:\php_project\single.jzb.com\public/../application/admin/view/banner/index_cate.html";i:1532138656;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/header.html";i:1532138656;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/footer.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <tbody id="article_list">
                            <?php if(is_array($cate) || $cate instanceof \think\Collection || $cate instanceof \think\Paginator): if( count($cate)==0 ) : echo "" ;else: foreach($cate as $key=>$vo): ?>
                                <tr class="long-td">
                                    ...
                                    <td class="cate_name edit-td"><div class="updateText" onclick="toggleInput(this,<?php echo $vo['id']; ?>,'name','banner_cate')"><?php echo $vo['name']; ?></div></td>
                                    <td class="edit-td"><div class="updateText" data-check="number" onclick="toggleInput(this,<?php echo $vo['id']; ?>,'sortnum','banner_cate')"><?php echo $vo['sortnum']; ?></div></td>
                                    <td>
                                        <?php switch($vo['banner_type']): case "0": ?>PC站<?php break; case "1": ?>手机站<?php break; case "2": ?>小程序<?php break; default: ?>错误
                                        <?php endswitch; ?>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="status" data-id="<?php echo $vo['id']; ?>" data-table="banner_cate" class="lcs_check lcs_switch lcs_sm" <?php if($vo['status'] == 1): ?>checked<?php endif; ?>/>
                                    </td>
                                    <td>
        ...
        $.getJSON('./del_cate', {'id' : id}, function(res){
            if(res.code == 1){
                layer.msg(res.msg,{icon:1,time:1500,shade: 0.1},function(){
                    window.location.href="<?php echo url('banner/index_cate'); ?>";
                });               
            }else{
