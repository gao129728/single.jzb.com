<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:83:"E:\php_project\single.jzb.com\public/../application/admin/view/structure/index.html";i:1532138656;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/header.html";i:1532138656;s:84:"E:\php_project\single.jzb.com\public/../application/admin/view/structure/global.html";i:1532138656;s:81:"E:\php_project\single.jzb.com\public/../application/admin/view/public/footer.html";i:1532138656;s:87:"E:\php_project\single.jzb.com\public/../application/admin/view/structure/global_js.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="file-manager" style="overflow:hidden; overflow-y:auto;">
            ...
            <div class="add_module">
                <a href="<?php echo url('index'); ?>">
                    ...
                    <div class="col-sm-8">
                        <form class="form-horizontal" name="add_structure" id="add_structure" method="post" action="<?php echo url('index'); ?>">
                            <div class="form-group">
                                <label class="col-sm-2" style="font-weight: 100; padding-left:20px; color:#ff6600;; font-size: 15px;">新增模块</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-4">
                                    <div class="radio i-checks">
                                        <input type="radio" name='show_style' value="0" checked/>主体居中&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name='show_style' value="1" />全屏通栏
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-4">
                                    ...
                                    <span class="help-question"><a data-toggle="tooltip" data-placement="auto right" title="有背景图时，则背景颜色选项无效"><i class="fa fa-question-circle-o"></i></a></span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-10">
                                    ...
                                    <div class="col-sm-1 input_wd3">
                                        <input type="text" class="form-control" id="topSpace" name="topSpace" value="40">
                                        <span class="tp-unit">px</span>
                                    </div>
                                    <span class="control-label" style="float:left; padding-left:60px;">下边距</span>
                                    <div class="col-sm-1 input_wd3">
                                        <input type="text" class="form-control" id="bottomSpace" name="bottomSpace" value="40">
                                        <span class="tp-unit">px</span>
                                    </div>
                                </div>
                            </div>
