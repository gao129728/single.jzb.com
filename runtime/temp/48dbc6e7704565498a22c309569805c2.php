<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:86:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/structure/add_module.html";i:1535011608;s:79:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/public/header.html";i:1532138656;s:82:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/structure/global.html";i:1532138656;s:79:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/public/footer.html";i:1532138656;s:85:"/www/wwwroot/jzb.ahcfwl.com/public/../application/admin/view/structure/global_js.html";i:1532138656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="file-manager" style="overflow:hidden; overflow-y:auto;">
            ...
            <div class="add_module">
                <a href="<?php echo url('index'); ?>">
                    ...
                    <div class="col-sm-8">
                        <form class="form-horizontal" name="add_module" id="add_module" method="post" action="<?php echo url('add_module'); ?>">
                            <input type="hidden" name="module_class" value="<?php echo $structure_id; ?>">
                            <div class="form-group">
                                <label class="col-sm-2" style="font-weight: 100; padding-left:20px; color:#ff6600;; font-size: 15px;">添加子版块</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-1">
                                    <input id="width" type="text" class="form-control input_wd1" name="width" value="0">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-8">
                                    <div class="radio i-checks">
                                        ...
                                        <input type="radio" name='titleStyle' value="2"/>标题样式2&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name='titleStyle' value="3"/>标签切换&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name='titleStyle' value="4"/>自定义&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="tit-more hidden-box">
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">显示"更多"：</label>
                                    <div class="col-sm-6 input-group">
                                        <input type="checkbox" name="isMore" value="1" class="lcs_check" lcs-text="是|否" autocomplete="off" checked/>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="set-item">
                                                    ...
                                                    <div class="item clearfix custom-tab-cate">
                                                        ...
                                                        <div class="con">
                                                            ...
                                                            <div class="custom-cate-list clearfix"></div>
                                                        </div>
                                                    </div>
                                                    <div class="item clearfix">
        ...
        function complete(data){
            if(data.code==1){
                layer.msg(data.msg, {icon: 6,time:1500,shade: 0.1}, function(index){
                    layer.close(index);
                    window.location.href='<?php echo url("structure/edit_module"); ?>?id='+data.data;
                });
            }else{
