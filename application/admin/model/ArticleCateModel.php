...
class ArticleCateModel extends Model
{
    ...
    {
        return $this->where($map)->order('orderby asc, id asc')->select();
    }
    ...
    {
        try{
            $result = $this->validate('ArticleCateValidate')->allowField(true)->save($param);
            if(false === $result){     
    ...
    {
        try{
            $result = $this->validate('ArticleCateValidate')->allowField(true)->save($param, ['id' => $param['id']]);
            if(false === $result){          
