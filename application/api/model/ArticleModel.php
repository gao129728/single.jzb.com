...
class ArticleModel extends Model
{
    ...
    {
        return $this->field('id,cate_id,title,photo,views,content,create_time')->where($map)->page($Nowpage, $limits)->order('sortnum desc, id desc')->select();
    }
    ...
    {
        return $this->field('id,cate_id,title,photo,views,intro,content,create_time')->where($map)->order('sortnum desc, id desc')->select();
    }
    ...
    {
        return $this->field('id,cate_id,title,photo,views,intro,content,create_time')->where($map)->order('sortnum desc, id desc')->find();
    }
    /**
     * [更新信息]
     */
